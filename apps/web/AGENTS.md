...
Regras específicas para mexer em `apps/web`. Herdam tudo de `../../AGENTS.md`.
...
| Debounce de input                | `useEffect` + `setTimeout`                    | Hook dedicado (`useDebouncedValue`) ou query `keepPreviousData` |
